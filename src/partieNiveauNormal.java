...
public class partieNiveauNormal {
    ...
    public static void main() {
        ...
        int toursPassesConsecutifs = 0; //Cette limitation permet d'éviter une boucle infini si les 2 joueurs ne peuvent plus jouer mais qu'il reste des cases vides.
    ...
    public static void placerPion(char[][] plateau, int ligne, int col, char couleurJoueur){
        while (ligne < 0 || ligne >= plateau.length || col < 0 || col >= plateau.length || plateau[ligne][col] != '.' || !coupPossible(plateau, ligne, col, couleurJoueur)){
